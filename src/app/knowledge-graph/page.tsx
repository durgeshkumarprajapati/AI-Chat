        ...
        >
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 mt-0.5">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 dark:bg-[#4edea3] animate-pulse" />
          ...
          <div data-tour="knowledge-graph-actions" className="flex items-center space-x-3 relative z-10 shrink-0">
            <div data-tour="knowledge-graph-search" className="flex items-center space-x-2 w-full sm:w-auto">
              ...
              <button
                onClick={fetchGraph}
                className="px-4 py-2 bg-indigo-600 dark:bg-gradient-to-r dark:from-[#4d8eff] dark:to-[#adc6ff] hover:opacity-95 text-white dark:text-[#0a0e18] rounded-xl text-xs font-bold transition shadow-md shadow-indigo-600/20 active:scale-[0.98] shrink-0"
              >
                Search
              </button>
            </div>
        ...
        {loading ? (
          <div className="bg-white dark:bg-[#0a0e18]/80 border border-slate-200 dark:border-[#424754] rounded-2xl p-16 flex flex-col items-center justify-center space-y-4 min-h-[480px]">
            ...
            <div className="text-center space-y-1">
              <p className="text-sm font-bold text-slate-900 dark:text-[#dfe2f1]">Extracting Graph Network...</p>
              <p className="text-xs text-slate-500 dark:text-[#8c909f] font-mono">Querying grounded entities & document citations</p>
            </div>
          </div>
        ) : activeTab === 'graph' ? (
            ...
            >
              ...
              <div className="flex justify-between items-center text-[11px] font-mono text-slate-600 dark:text-[#c2c6d6] border-b border-slate-200 dark:border-[#424754]/50 pb-3 relative z-10">
                <div className="flex items-center space-x-2">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 dark:bg-[#4edea3]" />
              ...
              {nodes.length === 0 ? (
                <div className="my-auto text-center space-y-3 p-10 relative z-10 max-w-md mx-auto">
                  ...
                  <div className="space-y-1">
                    <p className="text-base font-bold text-slate-900 dark:text-[#dfe2f1]">Your Knowledge Graph is currently empty</p>
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <div className="pt-2">
                    <Link
                      ...
                      className="w-full py-2.5 bg-indigo-600 dark:bg-gradient-to-r dark:from-[#4d8eff] dark:to-[#adc6ff] hover:opacity-95 text-white dark:text-[#0a0e18] rounded-xl text-center font-extrabold text-xs transition shadow-md shadow-indigo-600/20 block"
                    >
